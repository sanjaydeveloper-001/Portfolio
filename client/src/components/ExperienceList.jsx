...
const ExperienceList = () => {
  ...
  const fetchItems = () =>
    API.get('/experience')
      .then(r => setItems(toArray(r.data, 'experience', 'data')))
      .catch(() => {});
    ...
    <div>
      ...
      <div className="page-header" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <div>
          ...
          <p className="page-subtitle">Your professional work history and roles</p>
        </div>
        {!showForm && (
          <button className="btn btn-primary" onClick={() => setShowForm(true)}>+ Add Experience</button>
        )}
      </div>
      ...
      {showForm && (
        <div className="card" style={{ marginBottom: '20px' }}>
          <div className="card-header">
            <span className="card-title">{editing ? 'Edit Experience' : 'New Experience'}</span>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid form-grid-2">
                <div className="form-group">
                  ...
                  <input name="company" value={form.company} onChange={handleChange} placeholder="e.g. Google" className="form-input" required />
                </div>
                <div className="form-group">
                  <label className="form-label">Role / Title</label>
                  <input name="role" value={form.role} onChange={handleChange} placeholder="e.g. Software Engineer" className="form-input" required />
                </div>
                <div className="form-group">
                  <label className="form-label">Duration</label>
                  <input name="duration" value={form.duration} onChange={handleChange} placeholder="e.g. Jun 2023 – Present" className="form-input" required />
                </div>
                <div className="form-group">
                ...
                <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                  ...
                  <textarea name="description" value={form.description} onChange={handleChange} placeholder="What did you do? What did you build or achieve?" className="form-input" required />
                </div>
              </div>
